 ...
 */
public class LOLMatchesXMLConfig extends MongoTool {
    public LOLMatchesXMLConfig() {
        this(new Configuration());
    }

    public LOLMatchesXMLConfig(final Configuration conf) {
        setConf(conf);
